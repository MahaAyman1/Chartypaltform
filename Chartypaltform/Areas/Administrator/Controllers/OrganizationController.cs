...
namespace Chartypaltform.Areas.Administrator.Controllers
{
    ...
    public class OrganizationController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> ApproveOrganization(string id) 
        {
            ...
            if (organization != null)
            {
                ...
                TempData["success"] = "Organization approved successfully.";
            }
            else
            {
        ...
        public async Task<IActionResult> ApproveOrganization(string id, string reason)
        {
            ...
            if (organization != null)
            {
                ...
                if (adminUser != null)
                {
                    ...
                    {
                        ActionType = ActionType.ApproveCampaign,
                        ActionDetails = $"Campaign '{organization.OrganizationName}' status updated to 'Approved'.",
                        Reason = reason, 
        ...
        public async Task<IActionResult> RejectOrganization(string id, string reason)
        {
            ...
            if (organization != null)
            {
                ...
                if (adminUser != null)
                {
                    var adminAction = new AdminAction
                    {
                        ActionType = ActionType.RejectCampaign,
                        ActionDetails = $"Campaign '{organization.OrganizationName}' status updated to 'Rejected'.",
                        Reason = reason, 
                        Timestamp = DateTime.UtcNow,
                        AdminId = adminId,
                        AdminUser = adminUser
